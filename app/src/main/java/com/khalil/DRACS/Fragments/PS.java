...
public class PS extends Fragment {
    ...
    private void fetchDataFromFirestore() {
        ...
        FirestoreModel model = ((Activity_main) requireActivity()).getDataPreFetcher().getCachedData("ps");
        if (model != null) {
    ...
    private void tryExpandSection(Map<String, FirestoreModel.Section> sections, int attempt) {
        try {
            ...
            FirebaseCrashlytics.getInstance().log("Error expanding section in PS fragment. Attempt: " + attempt);
            e.printStackTrace();
        }
    }
